...
class GlitchCli(cmd.Cmd):
    ...
    def do_push(self, line):
      ...
      print("1. github")#! /usr/bin/env python3
...
class GlitchCli(cmd.Cmd):
    ...
    def do_prettier(self, line):
      ...
      prettierconfig = input("config type> ")
...
# -----------------------------------------------------------------------
    ...
    def help_prettier(self):
         print ( "prettier: ", "Generate a .prettierrc file with the configuration you like")
